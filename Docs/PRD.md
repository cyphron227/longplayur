...
- Genre mode offers an autocomplete on the search field, sourced live from Deezer's own genre list (not a hand-written list), to steer searches toward terms with real coverage.
